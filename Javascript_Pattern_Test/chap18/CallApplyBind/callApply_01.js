...
ReliableJavaScript.addValues = function(value1, value2) {
  // 두 인자를 받는 addValue는
  // 'this'에 'printResult' 메서드가 있다고 본다.
...
// 그리고 addValue가 덧셈할 값인 2와 3을 전달한다.

ReliableJavaScript.addValues.call(contextObject, 2, 3);

// addValues 함수를 apply 메서드로 실행한다.
// 여기서도 'this'가 바인딩될 객체를 contextObject로 넘겨준다.
// 마찬가지로, addValues가 덧셈할 값, 2와 3을 전달한다.
ReliableJavaScript.addValues.apply(contextObject, [2, 3]);
